...
export const PART_NOTES: Record<PartId, PartNote[]> = {
  '听力第一部分': [
    ...
    {
      name: 'Ước lượng: 左右 · 差不多 · 大概 · 至少',
      why: 'Câu ★ hay đổi con số đi một chút. 三十岁左右 không phải 三十岁, và cũng không sai — phải nghe cả từ ước lượng.',
      eg: [{ cn: '会议大概开了两个小时。', vi: 'Cuộc họp kéo dài khoảng hai tiếng.' }],
    },
  ],
  ...
  '听力第二部分': [
    {
      ...
      eg: [{ cn: '女的最可能是做什么的？', vi: 'Người nữ có khả năng làm nghề gì?' }],
    },
    {
  ...
  '听力第三部分': [
    ...
    },
    {
      ...
      eg: [{ cn: '在我看来，这件事值得再商量。', vi: 'Theo tôi, việc này đáng bàn lại.' }],
    },
  ],
  ...
  '阅读第二部分': [
    ...
    },
    {
      ...
      eg: [{ cn: '最后大家都同意了这个方案。', vi: 'Cuối cùng mọi người đều đồng ý phương án này.' }],
    },
  ],
  ...
  '阅读第三部分': [
    {
      ...
      eg: [{ cn: '这段话主要想告诉我们什么？', vi: 'Đoạn văn chủ yếu muốn nói với chúng ta điều gì?' }],
    },
    {
      ...
      eg: [{ cn: '很多人以为便宜没好货，其实并不一定。', vi: 'Nhiều người nghĩ rẻ thì không tốt, thực ra không hẳn.' }],
    },
    {
  ...
  '书写第一部分': [
    ...
    },
    {
      ...
      eg: [{ cn: '我的自行车被人骑走了。', vi: 'Xe đạp của tôi bị người ta đạp đi mất.' }],
    },
    {
      ...
      eg: [{ cn: '她跳舞跳得非常好。', vi: 'Cô ấy nhảy rất đẹp.' }],
    },
    {
    ...
    },
    {
      ...
      eg: [{ cn: '那是我买的两件新衣服。', vi: 'Đó là hai bộ đồ mới tôi mua.' }],
    },
  ],
  ...
  '书写第二部分': [
    {
      ...
      eg: [
        ...
        { cn: '（realize/意识）→ 我意识到自己错了。', vi: '(nhận ra) → Tôi nhận ra mình đã sai.' },
      ],
    },
    {
      ...
      eg: [{ cn: '正在打篮球。→ 他正在打篮球。', vi: 'Thiếu chủ ngữ → thêm 他.' }],
    },
    {
