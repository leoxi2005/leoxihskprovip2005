...
export const GAME_CARDS: GameCard[] = [
  ...
  { icon: '🧱', name: 'Dựng Câu', desc: 'Việt → Trung, xếp từng từ', bg: '#c96f2e', g: 'build', key: 'b' },
  { icon: '📝', name: 'Chép Chính Tả', desc: 'Nghe cả câu, gõ lại', bg: '#6b4fa8', g: 'sdict', key: 'd' },
  { icon: '🔢', name: 'Bẫy Số & Giờ', desc: '三点三刻 là mấy giờ?', bg: '#1f6b8f', g: 'num', key: 'n' },
  { icon: '🩹', name: 'Bắt Lỗi Sai', desc: 'Câu sai một chỗ — chỗ nào?', bg: '#b03a4a', g: 'fix', key: 'f' },
  { icon: '🧲', name: 'Kết Hợp Từ', desc: '提高 hay 增加 水平?', bg: '#2f7a5a', g: 'collo', key: 'c' },
